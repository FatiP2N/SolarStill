# -*- coding: utf-8 -*-
"""SolarstillOnline.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1WwpKNYOuwL2wOrqY-ewW3iXYEF6V7SlE
"""
...
# computes the function x -> x/2 + log(a+b.x) which zero corresponds to 1/sqrt(f_D)
    ...
    def Tinx(self,Ta0,Tb0):
        ...
        """
        if self.device=="Conventional" or "stepped":
            h=0
        else:
            h=self.hcga()
...
if __name__ == "__main__":
    ss = SolarStill("conventional.xlsx",6)
    ss.plot_device()
    ss.ss_performances(5)
    t1 = ss.simulate()
